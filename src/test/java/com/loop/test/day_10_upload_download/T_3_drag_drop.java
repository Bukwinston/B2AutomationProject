...
public class T_3_drag_drop {
    ...
    public void dragdrop (){
        ...
        WebElement amount1 = Driver.getDriver().findElement(By.id("amt7"));
        action.dragAndDrop(fiveK, amount1).perform();
        ...
        WebElement amount2 = Driver.getDriver().findElement(By.id("amt8"));
        action.dragAndDrop(fiveK, amount2).perform();

        WebElement successMessage = Driver.getDriver().findElement(By.xpath("//a[contains(.,'Perfect!')]"));
        String expected = "Perfect!";
        assertEquals(successMessage.getText(), expected, "NOT match");
