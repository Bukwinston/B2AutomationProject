...
public class T000_xpath_getYext {
    /*
...
//        2. Go to docuport
       ...
       // 3. Click on forgot password
        ...
        //6. enter forgotpasswordg1@gmail.com to email box
        WebElement emailBox = driver.findElement(By.xpath("//input[contains(@id,'input')]"));
       ...
       //7. validate cancel button is displayed
        ...
        if(cancelButton.isDisplayed()){
            ...
            System.err.println("TEST FAILED => Cencel button is NOT displayed");
        }
        ...
        sendButton.click();
//        We can Add waiting time before it start locating
       WebDriverWait wait = new WebDriverWait(driver, Duration.ofMillis(3000));
       wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//span[@class='body-1']")));
